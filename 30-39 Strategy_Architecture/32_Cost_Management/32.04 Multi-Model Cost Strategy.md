...
- [[32.06 FinOps Practices]] - Governance for model selection policies
- [[32.05 Training vs Inference Costs]] - Cost basis for model selection
- [[32.01 Cost Monitoring Tools]] - Track per-model costs
- [[11.21 Prompt Caching]] - Reduce per-model inference costs via KV cache reuse
