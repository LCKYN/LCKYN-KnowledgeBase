...
- [[72.30 Bucket Sort]] - Uses as stable sub-sort (counting sort)
- [[72.18 Sorting Algorithms Comparison]] - Context: linear time for fixed-width keys
- [[72.05 Space and Time Trade-Offs]] - O(n + k) space requirement
