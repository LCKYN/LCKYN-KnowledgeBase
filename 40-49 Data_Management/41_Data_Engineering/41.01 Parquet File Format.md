...
- Example: [1000, 1001, 1002, 1003] → 1000, [1, 1, 1, 1]
...
- Example: ["apple", "apply", "application"] → [(0, "apple"), (4, "y"), (4, "ication")]
...
graph TB
    ...
    B --> C["Snappy<br/>⚡ Fastest<br/>📦 Medium Compression"]
    B --> D["GZIP<br/>⏱️ Slower<br/>📦 High Compression"]
    B --> E["ZSTD<br/>⚖️ Balanced<br/>📦 High Compression"]
    B --> F["LZO<br/>⚡ Fast<br/>📦 Low Compression"]
    B --> G["Brotli<br/>⏱️ Slow<br/>📦 Highest Compression"]
